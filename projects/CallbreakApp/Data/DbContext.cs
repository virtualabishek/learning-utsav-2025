...
public class ApplicationDbContext : IdentityDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.Property(u => u.Id).HasColumnType("varchar(36)").HasMaxLength(36);
        ...
        {
            b.Property(l => l.LoginProvider).HasColumnType("varchar(128)").HasMaxLength(128);
            b.Property(l => l.ProviderKey).HasColumnType("varchar(128)").HasMaxLength(128);
        });

        builder.Entity<IdentityUserToken<string>>(b =>
        {
            b.Property(t => t.LoginProvider).HasColumnType("varchar(128)").HasMaxLength(128);
